...
NotificationLibrary:SendNotification("Warning", "cảm ơn vì dùng Tien Hub", 10)
NotificationLibrary:SendNotification("Warning", "https://discord.gg/z9yhUBrBcu", 10)
